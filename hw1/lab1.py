...
#print len(forward_chain([transitive_rule], poker_data))
...
#sibling_duplicate_rule = IF("sibling (?x) (?y)", THEN("sibling (?y), (?x)"))
...
#cousin_duplicate_rule = IF("cousin (?x) (?y)", THEN("cousin (?y), (?x)"))
...
WHAT_I_FOUND_INTERESTING = 'setting up recursion to make it easy'
WHAT_I_FOUND_BORING = 'very simple'
